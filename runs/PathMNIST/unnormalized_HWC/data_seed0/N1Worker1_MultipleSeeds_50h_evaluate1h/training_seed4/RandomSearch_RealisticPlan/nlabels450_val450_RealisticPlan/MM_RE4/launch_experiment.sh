...
# export train_dir="/cluster/tufts/hugheslab/zhuang12/SemiSelfEvaluationProject/SemiSelfEvaluation/experiments/$dataset_name/$normalization/data_seed$data_seed/N12Worker12_MultipleSeeds_50h_evaluate1h/training_seed$training_seed/RandomSearch_RealisticPlan/nlabels450_val450_RealisticPlan/$implementation"
# mkdir -p $train_dir
...
for training_seed in 1
do
    export training_seed=$training_seed
    export train_dir="/cluster/tufts/hugheslab/zhuang12/SemiSelfEvaluationProject/SemiSelfEvaluation/experiments/$dataset_name/$normalization/data_seed$data_seed/N1Worker1_MultipleSeeds_50h_evaluate1h/training_seed$training_seed/RandomSearch_RealisticPlan/nlabels450_val450_RealisticPlan/$implementation"
    mkdir -p $train_dir
