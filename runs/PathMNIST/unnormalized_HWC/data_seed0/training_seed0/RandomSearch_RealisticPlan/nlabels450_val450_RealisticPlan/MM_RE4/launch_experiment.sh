...
export train_dir="/cluster/tufts/hugheslab/zhuang12/SemiSelfEvaluationProject/SemiSelfEvaluation/experiments/$dataset_name/$normalization/data_seed$data_seed/training_seed$training_seed/RandomSearch_RealisticPlan/nlabels450_val450_RealisticPlan/$implementation"
mkdir -p $train_dir
