...
export data_seed=0
export training_seed=3
export nlabels=400 


export train_dir="/cluster/tufts/hugheslab/zhuang12/SemiSelfEvaluationProject/SemiSelfEvaluation/experiments/$dataset_name/$normalization/data_seed$data_seed/N12Worker12_MultipleSeeds_50h_evaluate1h/training_seed$training_seed/RandomSearch_RealisticPlan/nlabels400_val400_RealisticPlan/$implementation"
mkdir -p $train_dir
...
export u_train_dataset_path="/cluster/tufts/hugheslab/zhuang12/SemiSelfEvaluationProject/ML_DATA/MedMNIST/$dataset_name/$normalization/data_seed$data_seed/nlabels400_val400_realistic/u_train.npy"
