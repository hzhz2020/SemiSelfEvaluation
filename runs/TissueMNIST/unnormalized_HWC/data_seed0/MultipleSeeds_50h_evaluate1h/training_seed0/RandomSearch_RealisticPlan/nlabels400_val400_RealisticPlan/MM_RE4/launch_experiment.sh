...
export train_dir="/cluster/tufts/hugheslab/zhuang12/SemiSelfEvaluationProject/SemiSelfEvaluation/experiments/$dataset_name/$normalization/data_seed$data_seed/MultipleSeeds_50h_evaluate1h/training_seed$training_seed/RandomSearch_RealisticPlan/nlabels400_val400_RealisticPlan/$implementation"
mkdir -p $train_dir
