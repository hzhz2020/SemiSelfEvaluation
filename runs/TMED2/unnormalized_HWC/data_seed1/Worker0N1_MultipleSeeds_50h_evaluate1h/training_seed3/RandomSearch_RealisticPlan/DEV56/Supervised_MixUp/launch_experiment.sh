...
export implementation='Supervised_MixUp'
...
export train_dir="/cluster/tufts/hugheslab/zhuang12/SemiSelfEvaluationProject/SemiSelfEvaluation/experiments/$dataset_name/$normalization/data_seed$data_seed/Worker0N1_MultipleSeeds_100h_evaluate1h/training_seed$training_seed/RandomSearch_RealisticPlan/$development_size/$implementation"
mkdir -p $train_dir
