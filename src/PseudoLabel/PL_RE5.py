...
if __name__ == '__main__':
    ...
    print('unlabeledloss_warmup_schedule_type is {}'.format(args.unlabeledloss_warmup_schedule_type))
...
#     experiment_name = "dropout{}_lr{}_wd{}_lambda_u_max{}_unlabeledloss_warmup_iterations{}_lr_warmup_img{}_threshold{}_em{}".format(args.dropout_rate, args.lr, args.wd, args.lambda_u_max, args.unlabeledloss_warmup_iterations, args.lr_warmup_img, args.threshold, args.em)
    
    experiment_name = "Optimizer-{}_LrSchedule-{}_LrCycleLength-{}_UnlabeledlossWarmupSchedule-{}_UnlabeledlossWarmupIteations-{}_LambdaUMax-{}_lr-{}_wd-{}_threshold-{}_em-{}".format(args.optimizer_type, args.lr_schedule_type, args.lr_cycle_length, args.unlabeledloss_warmup_schedule_type, args.unlabeledloss_warmup_iterations, args.lambda_u_max, args.lr, args.wd, args.threshold, args.em)
