...
from libml.utils.vat import VAT
...
parser.add_argument('--eps', default=6, type=float)
...
def main(args, brief_summary):
    ssl_obj = VAT(eps=args.eps, xi=args.xi, n_iteration=1)
...
if __name__ == '__main__':
    ...
    experiment_name = "Optimizer-{}_LrSchedule-{}_LrCycleLength-{}_UnlabeledlossWarmupSchedule-{}_UnlabeledlossWarmupIteations-{}_LambdaUMax-{}_lr-{}_wd-{}_xi-{}_eps-{}_em-{}".format(args.optimizer_type, args.lr_schedule_type, args.lr_cycle_length, args.unlabeledloss_warmup_schedule_type, args.unlabeledloss_warmup_iterations, args.lambda_u_max, args.lr, args.wd,  args.xi, args.eps, args.em)
