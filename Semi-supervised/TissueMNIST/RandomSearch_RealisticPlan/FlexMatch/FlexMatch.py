...
#     TissueMNIST_std = (0.0799, 0.0799, 0.0799)
    ...
    u_train_dataset = dataset(args.u_train_dataset_path, transform_fn=TransformFixMatch(mean=TissueMNIST_mean, std=TissueMNIST_std))
...
#     global_best_train_ema_acc_at_val = 0
    ...
    while total_used_time <= args.total_hour: #run for 50 hour
